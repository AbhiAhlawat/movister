  ...
  return (
    <div className="faq">
      ...
      <div className="qna">
        ...
        <div className="panel">
          <p>
            MS-MOVREC is a streaming service that offers a wide variety of
        ...
        <div className="panel">
          <p>
            Watch MS-MOVREC on your smartphone, tablet, Smart TV, laptop, or
        ...
        <div className="panel">
          <p>
            ...
            with your MS-MOVREC account to watch instantly on the web at
            MS-MOVREC.com from your personal computer or on any internet-connected
            device that offers the MS-MOVREC app, including smart TVs,
            ...
            without an internet connection. Take MS-MOVREC with you anywhere.
          </p>
        </div>
        <button onClick={(e) => handleClick(e)} className="accordion">
          How do I cancel?
        ...
        <div className="panel">
          <p>
            MS-MOVREC is flexible. There are no annoying contracts and no
        ...
        <div className="panel">
          <p>
            MS-MOVREC has an extensive library of feature films, documentaries, TV
            shows, anime, award-winning MS-MOVREC originals, and more. Watch as
            much as you want, anytime you want.
          </p>
        </div>
        <button onClick={(e) => handleClick(e)} className="accordion">
          Is MS-MOVREC good for kids?
        </button>
        <div className="panel">
          <p>
            The MS-MOVREC Kids experience is included in your membership to give
